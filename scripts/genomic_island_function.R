...
##test inputs
#test_dir = '/stor/work/Ochman/alex/captive_ape_strain_genomes/scripts/test_data'
#setwd(test_dir)
#list.files()
#pres_abs <- read_csv('gene_presence_absence.csv',col_types = cols())
#captive_convergent_genes = readRDS('captive_convergent_genes.RDS')
...
#gff_window = parse_gff_window('P17.A3.gff',window_size=5)
...
#                               gff_file='P17.A3.gff',
#                               window_size = 5,
#                               outfile = 'output/P17.A3_window5_GIoutput.txt')
#
...
#output_island_fasta(
#  isolate='P17.A3',
#  genomic_islands_outfile = 'output/P17.A3_window5_GIoutput.txt',
#  island_fasta_outfile = 'output/fna/P17.A3_group_20589_group_20604_window5.fna',
...
#Count output
#countFAMILYoutput_file = "countOutput_Bacteroides_xylanisolvens_gainpenalty2.FAMILY"
#countTREE_file = "count_Bacteroides_xylanisolvens.tre"
...
#copynum_mrca_table = get_mrca("countOutput_Bacteroides_xylanisolvens_gainpenalty2.FAMILY",
#                            "count_Bacteroides_xylanisolvens.tre",
...
#iso1='P21.6D'
#iso2='P17.A3'
#iso1_gff_file='P21.6D.gff'
#iso2_gff_file='P17.A3.gff'
...
pairwise_gene_gain = function(pres_abs_file,iso1,iso2,iso1_gff_file,iso2_gff_file,
                              window_size,pw_outdir,countTREE_file,countOutput_file) {
 ...
 #get events
  ...
  filename = paste0(comp,'_window',as.character(window_size))
...
dir = '/stor/work/Ochman/alex/captive_ape_strain_genomes/results/pangenome'
#p1 = pairwise_gene_gain(
#   pres_abs_file = file.path(dir,"Bacteroides_xylanisolvens/roary_nosplitparalogs/gene_presence_absence.csv"),
#   iso1='P21.6E',
#   iso2='GCA.003436085.1.ASM343608v1',
#   iso1_gff_file=file.path(dir,'prokka/P21-6E/P21-6E.gff'),
#   iso2_gff_file=file.path(dir,'prokka/GCA_003436085.1_ASM343608v1/GCA_003436085.1_ASM343608v1.gff'),
#   window_size = 1,
#   pw_outdir = 'output/pw_gene_gain',
#   countTREE_file=file.path(dir,"Bacteroides_xylanisolvens/count/count_Bacteroides_xylanisolvens.tre"),
#   countOutput_file=file.path(dir,"Bacteroides_xylanisolvens/count/countOutput_Bacteroides_xylanisolvens_gainpenalty2.5.FAMILY"))
